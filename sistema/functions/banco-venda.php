        		    ...
        		    switch($tipovenda){
        		        case 1:
        		            if($idtipoprofissional == 1){
        		                ...
        		                $valor_relatorio = 'valor_consumidor';
        		            }else{
